...
我一开始就想做一个**个人色彩强**的博客。朋友给我看了 https://blog.lris625.top/ 这个站，我一搜网页源码，`<meta name="generator" content="Hexo 8.0.0">`，页脚写着 `hexo-theme-butterfly`。原来它用的是 **Hexo + Butterfly**，中文技术圈最常见的个人博客组合之一。

既然想要"像它那样的效果"，最省事的路就是**用同款引擎**，而不是用别的框架去模仿它。
...
| **Hexo + Butterfly** | 博客功能开箱即用、中文教程多、和参考站同款 | 学到的不是主流前端框架 |
| Next.js | 很酷、能完全自定义 | 内容管道全要自己写，工程量大 |

最后选了 Hexo + Butterfly。理由就一条：**我想要的观感参考站已经替我做出来了**，直接用同一套引擎还原度最高、折腾最少。
